CREATE DATABASE  IF NOT EXISTS `owncloud` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `owncloud`;
-- MySQL dump 10.13  Distrib 5.7.19, for Linux (x86_64)
--
-- Host: 34.195.42.154    Database: owncloud
-- ------------------------------------------------------
...
INSERT INTO `oc_accounts` VALUES (1,NULL,'admin','admin','admin',NULL,1506733389,'OC\\User\\Database','/var/www/html/data/admin',1);
...
INSERT INTO `oc_addressbookchanges` VALUES (1,'Database:admin.vcf',1,2,1);
...
INSERT INTO `oc_addressbooks` VALUES (1,'principals/users/admin','Contatos','contacts',NULL,1),(2,'principals/system/system','system','system','System addressbook which holds all users of this instance',2);
...
INSERT INTO `oc_appconfig` VALUES ('backgroundjob','lastjob','2'),('comments','enabled','yes'),('comments','installed_version','0.3.0'),('comments','types','logging,dav'),('configreport','enabled','yes'),('configreport','installed_version','0.1.1'),('configreport','types','filesystem'),('core','installedat','1506733269.7549'),('core','lastcron','1506733391'),('core','lastupdateResult','[]'),('core','lastupdatedat','1506735071'),('core','oc.integritycheck.checker','[]'),('core','public_files','files_sharing/public.php'),('core','public_webdav','dav/appinfo/v1/publicwebdav.php'),('dav','enabled','yes'),('dav','installed_version','0.3.0'),('dav','types','filesystem'),('federatedfilesharing','enabled','yes'),('federatedfilesharing','installed_version','0.3.1'),('federatedfilesharing','types','filesystem'),('federation','enabled','yes'),('federation','installed_version','0.1.0'),('federation','types','authentication'),('files','enabled','yes'),('files','installed_version','1.5.1'),('files','types','filesystem'),('files_external','enabled','yes'),('files_external','installed_version','0.7.1'),('files_external','ocsid','166048'),('files_external','types','filesystem'),('files_sharing','enabled','yes'),('files_sharing','installed_version','0.10.1'),('files_sharing','types','filesystem'),('files_trashbin','enabled','yes'),('files_trashbin','installed_version','0.9.1'),('files_trashbin','types','filesystem'),('files_versions','enabled','yes'),('files_versions','installed_version','1.3.0'),('files_versions','types','filesystem'),('files_videoplayer','enabled','yes'),('files_videoplayer','installed_version','0.9.8'),('files_videoplayer','types',''),('firstrunwizard','enabled','yes'),('firstrunwizard','installed_version','1.1'),('firstrunwizard','ocsid','166055'),('firstrunwizard','types',''),('market','enabled','yes'),('market','installed_version','0.2.2'),('market','types',''),('notifications','enabled','yes'),('notifications','installed_version','0.3.1'),('notifications','types','logging'),('provisioning_api','enabled','yes'),('provisioning_api','installed_version','0.5.0'),('provisioning_api','types','prevent_group_restriction'),('systemtags','enabled','yes'),('systemtags','installed_version','0.3.0'),('systemtags','types','logging'),('templateeditor','enabled','yes'),('templateeditor','installed_version','0.1'),('templateeditor','types',''),('updatenotification','enabled','yes'),('updatenotification','installed_version','0.2.1'),('updatenotification','types','');
...
INSERT INTO `oc_authtoken` VALUES (1,'admin','admin','4aaa7558f5a8e9363600546de78c1427|AKdQhZOGTP6nP5OM|5ff133a1dd10a579c668b80b791ac52415ab7a66500399c64510a4dc6b8d1684af60e451e551ea9335ff5b56de0640fd28a5a5fa665ec6c5914b42a42097164a','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36','310498002c6778aaea3835f9dbd6a9d8b97f1b1d6f94493f5ff845727cdc273cb7da4e8119dd9f385bc6a8fa4229421bec1fe24df9246e44a5dd7d4e223418bd',0,1506735521,1506735491);
...
INSERT INTO `oc_calendars` VALUES (1,'principals/users/admin','Pessoal','personal',1,NULL,0,'#1d2d44',NULL,'VEVENT,VTODO',0),(2,'principals/system/system','Contact birthdays','contact_birthdays',1,NULL,0,'#FFFFCA',NULL,'VEVENT,VTODO',0);
...
27,''),(12,2,'files/Photos/Squirrel.jpg','de85d1da71bcd6232ad893f959063b8c',9,'Squirrel.jpg',7,6,233724,1506733389,1506733389,0,0,'68af44e1516ecb51327e3f1367f7ba99',27,''),(13,1,'avatars','aec9f4efc5a055bbd053f220538c61e0',1,'avatars',2,1,0,1506733390,1506733389,0,0,'59ceed4e06c4a',31,''),(14,1,'avatars/21','ad6861de6e7fc46a455df0acc3655dec',13,'21',2,1,0,1506733390,1506733389,0,0,'59ceed4e06c4a',31,''),(15,1,'avatars/21/23','cb64392e5da27306a608dc0195e783f7',14,'23',2,1,0,1506733390,1506733390,0,0,'59ceed4e06c4a',31,''),(16,1,'avatars/21/23/2f297a57a5a743894a0e4a801fc3','529dc0f71e29aa0491601dcd32bdd56d',15,'2f297a57a5a743894a0e4a801fc3',2,1,0,1506733390,1506733390,0,0,'59ceed4e047fc',31,'');
...
INSERT INTO `oc_jobs` VALUES (1,'OCA\\Market\\CheckUpdateBackgroundJob','null',1506733280,1506733280,0,14),(2,'OCA\\DAV\\CardDAV\\SyncJob','null',1506733391,1506733391,0,0),(3,'OCA\\Files_Sharing\\DeleteOrphanedSharesJob','null',0,1506733270,0,-1),(4,'OCA\\Files_Sharing\\ExpireSharesJob','null',0,1506733270,0,-1),(5,'OCA\\Federation\\SyncJob','null',0,1506733270,0,-1),(6,'OCA\\Files\\BackgroundJob\\ScanFiles','null',0,1506733270,0,-1),(7,'OCA\\Files\\BackgroundJob\\DeleteOrphanedItems','null',0,1506733270,0,-1),(8,'OCA\\Files\\BackgroundJob\\CleanupFileLocks','null',0,1506733270,0,-1),(9,'OCA\\UpdateNotification\\Notification\\BackgroundJob','null',0,1506733270,0,-1),(10,'OCA\\Files_Trashbin\\BackgroundJob\\ExpireTrash','null',0,1506733271,0,-1),(11,'OCA\\Files_Versions\\BackgroundJob\\ExpireVersions','null',0,1506733271,0,-1),(12,'\\OC\\Authentication\\Token\\DefaultTokenCleanupJob','null',0,1506733271,0,-1);
...
INSERT INTO `oc_migrations` VALUES ('core','20170101010100'),('core','20170101215145'),('core','20170111103310'),('core','20170213215145'),('core','20170214112458'),('core','20170221114437'),('core','20170221121536'),('core','20170315173825'),('core','20170320173955'),('core','20170418154659'),('core','20170516100103'),('core','20170526104128'),('core','20170605143658'),('core','20170711191432'),('core','20170804201253'),('dav','20170116150538'),('dav','20170116170538'),('dav','20170202213905'),('dav','20170202220512'),('dav','20170427182800'),('dav','20170519091921'),('dav','20170526100342'),('dav','20170711193427'),('federatedfilesharing','20170804201125'),('federatedfilesharing','20170804201253'),('files_external','20170814051424'),('files_sharing','20170804201125'),('files_sharing','20170804201253'),('files_sharing','20170830112305'),('files_trashbin','20170804201125'),('files_trashbin','20170804201253'),('notifications','20170801085340'),('notifications','20170801152524');
...
INSERT INTO `oc_mounts` VALUES (1,2,3,'admin','/admin/');
...
CREATE TABLE `oc_notifications` (
  ...
  `message` varchar(64) COLLATE utf8mb4_bin NOT NULL,
  `message_parameters` longtext COLLATE utf8mb4_bin,
  `link` varchar(4000) COLLATE utf8mb4_bin NOT NULL,
...
INSERT INTO `oc_preferences` VALUES ('admin','core','lang','pt_BR'),('admin','firstrunwizard','show','0');
...
INSERT INTO `oc_storages` VALUES ('local::/var/www/html/data/',1,1,NULL),('home::admin',2,1,NULL);
...
INSERT INTO `oc_users` VALUES ('admin',NULL,'1|$2y$10$mv4yKPMYE0F4Pv9FAuLsBeVGPPantxiZLo7ua9z3/QgNSnQGkoVEK');
...
-- Dump completed on 2017-09-29 22:40:10
